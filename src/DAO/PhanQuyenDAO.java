...
public class PhanQuyenDAO {
    ...
    public PhanQuyenDTO getTenTK(int idQuyen) throws SQLException {
    String sql = "SELECT phanquyen.tenQuyen FROM phanquyen, taikhoan WHERE phanquyen.idQuyen = taikhoan.idQuyen AND taikhoan.idQuyen = ?";
