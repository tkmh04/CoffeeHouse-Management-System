 ...
 * @author asus
 */
public class EditKHGUI extends JFrame {
    ...
    public EditKHGUI() {
        ...
        btnConfirm.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                ConfirmDialog confirmDialog = new ConfirmDialog(EditKHGUI.this, "Xác nhận thay đổi", "Bạn có chắc muốn sửa?");
                confirmDialog.setVisible(true);
                if (confirmDialog.isConfirmed())
                {
                    khDAO.updateKhachHang(updateNl);
