...
//    static int currentMaQuyen = 1;
    String[] tenCacHang = {"Menu", "Phiếu Nhập", "Phiếu Xuất", "Nhân Viên", "Khách Hàng", "Thống Kê", "Tài Khoản", "Nguyên Liệu", "Phân Quyền"};
    ////////
    ...
    void initComponent()  {
        ...
        them.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                centerframe.setLayout(new GridLayout(9,1));
